                ...
                <div class="row">
                    ...
                    <div class="col-2">
                        <div class="form-group has-icon-left">
                            ...
                            <div class="position-relative">
                                ...
                                <select id="store_select" class="form-control" onchange="list_variance()">
                    ...
                    <div class="col-3">
                        <div class="form-group has-icon-left">
                            ...
                            <div class="position-relative">
                                ...
                                <input id="s_date" type="date" class="form-control" onchange="list_variance()">
                                <div></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-3">  
                        <div class="form-group has-icon-left">
                            ...
                            <div class="position-relative">
                                <input id="e_date" type="date" class="form-control" onchange="list_variance()">
                                <div class="form-control-icon">
                                    <i data-feather="plus-square"></i>
                                </div>
                            </div>
                    ...
                    ?>
                        <div class="col-4" style="padding-top: 20px;">
                            <button class="btn btn-primary mr-1 mb-1" onclick="printPDF_variance()">PRINT</button>
                        </div>
                    <?php } ?>
