          ...
          <div class="card-content">
              <div class="card-body">
                  ...
                  <div class="form-body">                      
                        ...
                        <div class="row" <?php if(!in_array($_SESSION['access_type'],array('liquidation'))){ echo 'style="margin-left: 261px;"'; }  ?>> 
                        <div class="col-2">
                            <?php
                          ...
                          <div class="col-9" style="display: flex;">                             
                           <label for="date_from" style="margin-right: 10px;">From:</label>
                                ...
                                <label hidden for="date_to" style="margin-left:20px; margin-right: 10px;">To:</label>
                                <input hidden type="date" id="date_to" name="date" style="font-family:sans-serif; margin-right: 10px;" onchange="validateDates()">
                                
                                <?php if(in_array($_SESSION['access_type'],array('accounting','liquidation')))
                                      {
                                 ?>
                                             <a class="btn icon icon-left btn-success btn-sm" style="margin-left:20px; margin-right: 96px;" onclick="generate_eod_report()"><i data-feather="file"></i> Generate Report</a>
                               
                                <?php } ?>         
                                <?php if(in_array($_SESSION['access_type'],array('liquidation')) && $_SESSION['db_id'] != 19)
                                      {
                                 ?>

                                            <form action="" name="save_textfile" id="save_textfile" enctype="multipart/form-data" method="post">                                 
                                              <input type="hidden" name="MAX_FILE_SIZE" value="8000000">                                 
                                              <input type="file" class="btn btn-default" name="files[]" id="txt_file" multiple="multiple" style="display: inline-block; padding: 0px; width: 44%; margin-right: 10px;">                              
                                              <button type="button" class="btn btn-info" id="view-btn" style="padding: 1px 6px; margin-right: 10px;" onclick="extract_file('EOD')"><i class="glyphicon glyphicon-upload"></i> upload Navision files</button>    
                                            </form> 

                                            <button type="button" class="btn btn-warning" id="view-btn" style="padding: 1px 6px; margin-right: 10px;" onclick="extract_dataport_file('EOD')"><i class="glyphicon glyphicon-upload"></i>Generate Dataport Filter</button> 
                               <?php } ?>             
                                            ...
                                            else 
                                            {
                                                ...
                                                $.ajax({
                                                           ...
                                                           // url:'<?php echo base_url(); ?>Cuponing_ctrl/load_eod_ui_filter',
                                                            url:'<?php echo base_url(); ?>Cuponing_ctrl/EOD_report',
                                                            data:{
